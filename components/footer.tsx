...
const navigation = [
    ...
    {
        name: 'GitHub',
        href: 'https://github.com/Ayush583-Aswal',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
            <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
    ...
    {
        name: 'X',
        href: 'https://x.com/Ayush5831?t=JVRa5mL-7cHiHep65cFHQw&s=09',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
            <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
    ...
    {
        name: 'Instagram',
        href: 'https://www.instagram.com/ayushaswal583?igsh=MWl0MTU0Y3UwNXlldg==',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
            <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
